      ...
      <main className="flex-grow max-w-3xl mx-auto px-4 py-12 w-full">
        <article className="prose prose-sm md:prose-base max-w-none">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">
            Politique de confidentialité — Commently
          </h1>
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            <p>
              Commently utilise l'API YouTube pour accéder aux commentaires de votre chaîne. Nous ne stockons pas vos données YouTube. Nous utilisons votre adresse Gmail uniquement pour vous identifier et vous connecter à votre chaîne. Vos données ne sont jamais vendues ni partagées avec des tiers. Vous pouvez révoquer l'accès à tout moment depuis votre compte Google.
            </p>
